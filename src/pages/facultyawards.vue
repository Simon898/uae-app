  ...
  <div>
    ...
    <div class="mx-auto max-w-screen-xl">
      ...
      <div class="flex content-center justify-center">
        <h1 class="mt-10 text-3xl font-medium text-gray-600">Faculty Awards</h1>
      </div>
      <div
      ...
      >
        <a v-if="item.category == 'FA'" :href="item.link">
          <div v-if="item.category == 'FA'" class="text-xl font-light">
            <span class="mb-5 border-gray-600 hover:border-b-2">
              {{ item.title }}
            </span>
          </div>
        </a>
        <div v-if="item.category == 'FA'" class="mt-3">
